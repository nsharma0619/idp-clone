...
class IdpCourseScraperSpider(scrapy.Spider):
    ...
    def start_requests(self):
        yield scrapy.Request('https://www.idp.com/global/search/building-and-architecture/', self.parse, meta={'area_study' : 'building-and-architecture'})
        yield scrapy.Request('https://www.idp.com/global/search/business/', self.parse, meta={'area_study' : 'business'})
        yield scrapy.Request('https://www.idp.com/global/search/chemistry/', self.parse, meta={'area_study' : 'chemistry'})
        yield scrapy.Request('https://www.idp.com/global/search/computing-and-it/', self.parse, meta={'area_study' : 'computing-and-it'})
        yield scrapy.Request('https://www.idp.com/global/search/economics/', self.parse, meta={'area_study' : 'economics'})
        yield scrapy.Request('https://www.idp.com/global/search/engineering/', self.parse, meta={'area_study' : 'engineering'})
        yield scrapy.Request('https://www.idp.com/global/search/environmental-science/', self.parse, meta={'area_study' : 'environmental-science'})
        yield scrapy.Request('https://www.idp.com/global/search/finance/', self.parse, meta={'area_study' : 'finance'})
